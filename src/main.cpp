...
uint256 hashGenesisBlock("0x7d60a0e672e1d6ce1bb2cb145904db4827221dcf976568d10c3114ba2b4059f6");
...
static const int64 nTargetSpacing = 45 * 60;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
	...
	static const int64	BlocksTargetSpacing			= 45 * 60;
	unsigned int		TimeDaySeconds				= 60 * 60 * 24;
	int64				PastSecondsMin				= TimeDaySeconds * 45 * 0.1;
	int64				PastSecondsMax				= TimeDaySeconds * 45 * 2.8;
...
{
    // FrogCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "FrogCoin Genesis Block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 2 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0401847105a679ad4023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1426201798;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1583621;
	    ...
	    assert(block.hashMerkleRoot == uint256("0xe14b181ad43d9c267405f75d97c2ff7f8e788a6712bb80777b54166e2b0093a4"));
        block.print();
